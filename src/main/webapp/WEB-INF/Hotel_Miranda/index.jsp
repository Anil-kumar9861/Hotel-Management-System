  ...
  <body>
      ...
      <div class="section__container intro__container">
        <div class="intro__cotent">
          ...
          <p class="section__description">
            ...
            journey beneath the surface, Hotel Nova promises to be an
        ...
        <div class="intro__video">
          <video src="../assets/img/luxury.mp4" autoplay muted loop></video>
        </div>
      </div>
    </section>
    ...
    <section class="menu" id="menu">
      <div class="section__container menu__container">
        ...
        <ul class="menu__items">
          <li>
            <img src="../assets/img/menu-1.jpg" alt="menu" />
          ...
          <li>
            <img src="../assets/img/menu-2.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Tea or Coffee</h4>
              <p>
          ...
          <li>
            <img src="../assets/img/menu-3.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Chia Oatmeal</h4>
              <p>
          ...
          <li>
            <img src="../assets/img/menu-4.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Fruit Parfait</h4>
              <p>
          ...
          <li>
            <img src="../assets/img/menu-5.jpg" alt="menu" />
            <div class="menu__details">
          ...
          <li>
            <img src="../assets/img/menu-6.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Cheese Plate</h4>
              <p>
        ...
        <div class="menu__images">
          <img src="../assets/img/menu-7.jpg" alt="menu" />
          <img src="../assets/img/menu-8.jpg" alt="menu" />
          <img src="../assets/img/menu-9.jpg" alt="menu" />
        </div>
    ...
    <section class="section__container news__container" id="news">
      ...
      <div class="news__grid">
        ...
        <div class="news__card">
          <img src="../assets/img/news-7.jpg" alt="news" />
          <div class="news__card__title">
            <p>15th June 2022</p>
            <p>By David</p>
          </div>
      ...
      <div class="section__container footer__container">
        <div class="footer__col">
          ...
          <p class="section__description">
            ...
            escape from the ordinary, inviting you to explore a subterranean world of wonders.
          </p>
    ...
    <script src="../assets/coustomjs/main.js"></script>
  </body>
  <script>
